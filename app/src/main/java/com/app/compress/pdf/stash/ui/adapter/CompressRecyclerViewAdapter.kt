...
import com.app.compress.pdf.stash.util.pdfManipulator.getCompressedPDFPath
...
class CompressRecyclerViewAdapter(
    ...
    private val pdfList: MutableList<Pdf>,
    private val onNavigationClickListener: OnNavigationClickListener,
    private val activity: Activity
) :
    RecyclerView.Adapter<CompressRecyclerViewAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = PdfRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.binding.rowDate.text = FileUtils.formatDate(pdf.date)
...
//            FileUtils.openPdfFile(context, pdf.filePath)
        ...
        holder.binding.rowCompressButton.setOnClickListener {
    ...
    private fun showConfirmationDialog(pdf: Pdf) {
        ...
        val confirmationPopupBinding =
            ConfirmationPopupBinding.inflate(LayoutInflater.from(context))
    ...
    private fun showAds(pdf: Pdf) {
        mRewardedAd!!.fullScreenContentCallback = object : FullScreenContentCallback() {
            ...
            override fun onAdDismissedFullScreenContent() {
                ...
                mRewardedAd = null
                onNavigationClickListener.openCompressFragment()
            }
        }
        if (mRewardedAd != null) {
